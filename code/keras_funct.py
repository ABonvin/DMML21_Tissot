...
#Counts the type of each type of token in a sentence, our first feature. (This version is for the unlabelled data)
def type_counter_unlabelled(df_fit, df_transform):
    nlp = spacy.load('fr_core_news_md')
    dif_typ = []
    
#Create a list of all they types of tokens    
    ...
    res = []
 #Increase the counter on each type of tokens for each sentence    
